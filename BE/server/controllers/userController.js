...
const addAddress = async (req, res) => {
  try {
    ...
    res.status(200).json({ msg: 'Address added successfully', addresses: user.client_profile.addresses });
  } catch (error) {
...
const editAddress = async (req, res) => {
  try {
    ...
    const addressIndex = user.client_profile.addresses.findIndex(addr => addr._id.toString() === addressId);
    if (addressIndex === -1) {
    ...
    res.status(200).json({ msg: 'Address updated successfully', addresses: user.client_profile.addresses });
  } catch (error) {
...
const deleteAddress = async (req, res) => {
  try {
    ...
    res.status(200).json({ msg: 'Address deleted successfully', addresses: user.client_profile.addresses });
  } catch (error) {
